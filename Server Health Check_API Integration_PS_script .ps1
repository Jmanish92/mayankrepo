...
send-mailmessage -from "Noida SPB Health Check <noreply@cadence.com>" -to "tmayank@cadence.com" -subject "The D drive free space is below 95%" -body "The d drive free space is full on $computername. It is runing with $driveinfo.Freespace in bytes" -priority High -dno onSuccess, onFailure -smtpServer mailin
...
#-------------------------------------------------API-----------created on (24/7/2020)-----Implemented (28/7/2020)-----------Requestor : Ankit Kumar Singhal---------------------------------------------------

$url = "https://pvtools.cadence.com/compass/api/get-table-from-seq-list?seq="
$seq = $record.API
...
$url = "http://noi-pvtools.cadence.com/compass/api/get-wint-farm-data?"
$key = "wintData="
...
#*****************Output File Name Change****created by Mayank Tripathi(28/07/20202)****Requestor : Vikash gupta*************************************************************************
